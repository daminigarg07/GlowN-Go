...
st.markdown(
    """
    <style>
    /* Apply the black gradient background */
    .stApp {
    ...
    .footer {
        ...
        font-size: 1rem;
        color: #fff;
        background-color: rgba(0, 0, 0, 0.5); /* Slightly dark background for footer */
        width: 100%;
    }
    </style>
    """,
...
# --- Main Page Content ---
# Centered logo on the main screen with rectangular dimensions
st.markdown('<div class="logo-container">', unsafe_allow_html=True)
st.image('Designer.png', width=500, use_container_width=False)
st.markdown('</div>', unsafe_allow_html=True)

st.markdown('<h1 class="main-title">GlowN\'Go - Virtual Makeup Try-On</h1>', unsafe_allow_html=True)

# Sidebar content without the logo
status1 = st.sidebar.selectbox(
    "SELECT AN OPTION:",
    ('LIVE MAKEUP TRY-ON', 'MAKEUP ON PHOTO', 'MAKEUP TRANSFER')
)

# Display content based on the selected makeup option (status1)
if status1 == 'LIVE MAKEUP TRY-ON':
    st.markdown("#### LIVE MAKEUP TRY-ON")
    st.write("Experience real-time makeup application through your camera feed. Explore various styles and see instant results!")
elif status1 == 'MAKEUP ON PHOTO':
    st.markdown("#### MAKEUP ON PHOTO")
    st.write("Upload your photo and try on various makeup looks virtually. Watch your transformation come to life!")
elif status1 == 'MAKEUP TRANSFER':
    st.markdown("#### MAKEUP TRANSFER")
    st.write("Transfer makeup styles from one image to another. Blend your look with inspiration from others!")
...
if status1=='MAKEUP TRANSFER':
    ...
    sp = dlib.shape_predictor("C:\\Users\\hp\\Downloads\\Virtual-Makeup-Try-on-main\\shape_predictor_68_face_landmarks.dat") # path of shape_predictor_68_face_landmarks.dat
...
#face extraction and alignment
    ...
    # test
    test_img = dlib.load_rgb_image(r"C:\Users\hp\Downloads\Virtual-Makeup-Try-on-main\02.jpg") # 02.jpg
    ...
    saver = tf.train.import_meta_graph("model/checkpoint/model.meta") # path of model.meta
...
st.markdown('<div class="footer">© 2025 GlowN\'Go. All rights reserved.</div>', unsafe_allow_html=True)
